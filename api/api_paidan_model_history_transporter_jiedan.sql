...
# @创建日期: 2015-12-17
# @备注: 每天运行之前15天内达达接单数据
# @目标表: dw_api.api_paidan_model_history_transporter_jiedan
# @来源表: dw_api.api_paidan_model_order_history
#################################

create table if not exists dw_api.api_paidan_model_history_transporter_jiedan(
...
create index idx2 on dw_api.api_paidan_model_history_transporter_jiedan(create_dt);


-- 达达15天内的接单数据
insert into dw_api.api_paidan_model_history_transporter_jiedan
(create_dt,
transporter_id,
