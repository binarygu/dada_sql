...
# @描述: 派单模型15天内达达商家派单数据
# @创建日期: 2015-12-17
# @备注: 每天运行之前15天内达达商家派单数据
# @目标表: dw_api.api_paidan_model_history_transporter_supplier_paidan
# @来源表: dw_api.api_paidan_model_transporter_order_history
#################################

create table if not exists dw_api.api_paidan_model_history_transporter_supplier_paidan(
    id bigint(20) not null primary key auto_increment,
    create_dt date,
    transporter_id bigint(20),
    supplier_id bigint(20),
	transporter_supplier_before_one_day_paidan_num decimal(10, 2),
	transporter_supplier_before_one_day_paidan_success_num decimal(10, 2),
	transporter_supplier_before_one_day_paidan_lv decimal(10, 6),
 	transporter_supplier_before_seven_day_paidan_num decimal(10, 2),
 	transporter_supplier_before_seven_day_paidan_success_num decimal(10, 2),
 	transporter_supplier_before_seven_day_paidan_lv decimal(10, 6),
	transporter_supplier_before_fourteen_day_paidan_num decimal(10, 2),
 	transporter_supplier_before_fourteen_day_paidan_success_num decimal(10, 2),
 	transporter_supplier_before_fourteen_day_paidan_lv decimal(10, 6)
);
create index idx1 on dw_api.api_paidan_model_history_transporter_supplier_paidan(transporter_id);
create index idx2 on dw_api.api_paidan_model_history_transporter_supplier_paidan(supplier_id);
create index idx3 on dw_api.api_paidan_model_history_transporter_supplier_paidan(create_dt);


-- 达达商户15天内的派单数据
insert into dw_api.api_paidan_model_history_transporter_supplier_paidan
(create_dt,
transporter_id,
supplier_id,
